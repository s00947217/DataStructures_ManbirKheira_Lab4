...
// Answer: I would choose insertion sort for smaller datasets due to its simplicity and bubble sort isn't efficient for large datasets.

// Question: Was there a difference in time taken by bubble sort and insertion sort?
// Answer: Yes, insertion sort was faster, which makes sense since bubble sort has a higher time complexity (O(n^2)).

// Question: Which sort algorithm has an easier implementation (in terms of understanding) to you?
// Answer: Bubble sort feels easier to understand since it's just swapping elements till sorted.
